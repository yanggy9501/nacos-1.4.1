...
public class NamingProxy {
    ...
    public static void syncCheckSums(byte[] checksums, String server) {
        try {
            ...
            // uri: /v1/ns/distro/checksum 下一个入口：com.alibaba.nacos.naming.controllers.DistroController.syncChecksum
    ...
    public static boolean syncData(byte[] data, String curServer) {
        ...
        try {
            // uri: /v1/ns/distro/datum 下一个入口：com.alibaba.nacos.naming.controllers.DistroController.onSyncDatum
