 ...
 * @author nkorange
 */
// nacos server 服务管理者，管理nacos所有的服务信息（包括服务，集群，实例）
@Component
public class ServiceManager implements RecordListener<Service> {

    /**
     * Map(namespace, Map(group::serviceName, Service)). 管理所有服务信息
     */
    ...
    /**
     * Create service if not exist. 如果服务不存在则创建
     *
     * @param namespaceId namespace
     * @param serviceName service name
     ...
     * @param action    {@link UtilsAndCommons#UPDATE_INSTANCE_ACTION_REMOVE} or
     *                  {@link UtilsAndCommons#UPDATE_INSTANCE_ACTION_ADD}
     * @param ephemeral whether instance is ephemeral
     * @param ips       instances
