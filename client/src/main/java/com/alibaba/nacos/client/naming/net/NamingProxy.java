...
/**
 * Naming proxy. nacos 客户端 （http）通信工具的封装，用以 nacos 服务端通信
 *
 * @author nkorange
 */
public class NamingProxy implements Closeable {
    ...
    // 单机模式下 nacos server 地址
    private String nacosDomain;
    // nacos server 地址列表
    private List<String> serverList;
    // 从 nacos server 拿回来的服务列表
    ...
    public NamingProxy(String namespaceId, String endpoint, String serverList, Properties properties) {
        /**
         * 安全认证: ncaos client 请求 nacos server 首先需要登录认证产生会话
         */
    ...
    private void initRefreshTask() {
        ...
        // TODO 验证是否是对的？
        /**
         * 每隔30s 刷新 nacos server 列表 （主要用于集群下的寻址）
         */
    ...
    /**
     * register a instance to service with specified instance properties. 向nacos server 注册一个服务实例
     *
    ...
    /**
     * Request api. 请求 nacos server  api 完成相关操作，这是一个通用方法
     *
     * @param api     api              api路径
    ...
    /**
     * Call server. 调用 nacos server  api
     *
     * @param api       api
     * @param params    parameters
     * @param body      body
